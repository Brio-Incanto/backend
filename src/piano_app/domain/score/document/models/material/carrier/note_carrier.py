...
if TYPE_CHECKING:
    ...
    from piano_app.domain.score.document.models.material.primitive.note import Note
    from piano_app.domain.score.document.models.relations.group import NoteCarrierGroupRelation
