...
from piano_app.domain.score.document.models.context.elements.point import (
...
if TYPE_CHECKING:
    from piano_app.domain.score.document.models.structural import Staff, TemporalAnchor, Voice
