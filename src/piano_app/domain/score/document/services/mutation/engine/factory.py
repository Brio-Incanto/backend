...
def _build_analyzer_registry() -> MutationAnalyzerRegistry:
    ...
    registry.register(
        request_type=DeleteRhythmicGroupRequest,
        analyzer=DeleteRhythmicGroupAnalyzer(),
    )
    registry.register(
        request_type=CreateTemporalAnchorRequest,
        analyzer=CreateTemporalAnchorAnalyzer(),
    )
    registry.register(
...
def _build_handler_registry() -> MutationHandlerRegistry:
...
def _build_postprocessors() -> list[MutatedStatePostprocessor]:
    return [FillGapsPostprocessor(), CleanupPostprocessor()]
