...
from piano_app.domain.score.services.helpers.interval import Interval
from piano_app.domain.score.services.helpers.scope import interval_in_parent_scope
